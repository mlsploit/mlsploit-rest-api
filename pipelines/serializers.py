...
def get_owned_hyperlinked_related_files_field_for_run(*attr_args, **attr_kwargs):
...
class JobSerializer(OwnedHyperlinkedModelSerializer):
    class Meta:
        ...
        read_only_fields = ("owner", "run", "task", "parent_job", "date_created")
...
class RunSerializer(OwnedHyperlinkedModelSerializer):
    ...
    class Meta:
        model = Run
        fields = ("id", "url", "owner", "pipeline", "files", "jobs", "date_created")
