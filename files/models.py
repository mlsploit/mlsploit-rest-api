...
class File(models.Model):
    ...
    kind = models.CharField(max_length=100, choices=FileKind.choices(),
                            default=FileKind.INPUT.value, blank=False)
    tags = models.TextField(default='{}')
    parent_file = models.ForeignKey('self', on_delete=models.SET_NULL,
                                    null=True, related_name='modified_versions')
